...
const fixtures = {
  csharp: {
    ...
    'cs-interfaces': `using System; interface IRunner { string Run(); } class Agent : IRunner { public string Run() => "running"; } class Program { static void Main() { Console.WriteLine(new Agent().Run()); } }`,
  ...
  cpp: {
    ...
    'cpp-unique': `#include <iostream>\n#include <memory>\nint main() { std::unique_ptr<int> value = std::make_unique<int>(7); std::cout << *value; return 0; }`,
