    ...
    modules: [
      ...
      },
      {
        id: 'cpp-memory', title: 'Memory & RAII', lessons: [
          ...
          lesson('cpp-rule', 'Rule of Zero & Five', 30, ['Define ownership semantics', 'Use RAII members', 'Keep special members correct'], `#include <memory>\nclass Buffer { std::unique_ptr<int[]> data; /* TODO */ };`, [{ kind: 'structural', value: 'std::unique_ptr' }, { kind: 'structural', value: 'class Buffer' }], ['ownership safe', 'VERIFICATION PASSED — 2/2 assertions green'], 'cpp-move'),
        ],
      },
      {
