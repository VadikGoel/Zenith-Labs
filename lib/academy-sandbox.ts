...
export function buildSandboxArgs(
  ...
  const common = [
    ...
    '--memory', language === 'csharp' && phase === 'compile' ? ACADEMY_SANDBOX.csharpCompileMemory : phase === 'run' ? ACADEMY_SANDBOX.runtimeMemory : ACADEMY_SANDBOX.memory,
    '--memory-swap', language === 'csharp' && phase === 'compile' ? ACADEMY_SANDBOX.csharpCompileMemory : phase === 'run' ? ACADEMY_SANDBOX.runtimeMemory : ACADEMY_SANDBOX.memory,
